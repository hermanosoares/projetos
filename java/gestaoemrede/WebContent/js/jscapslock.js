var capslock = {
  ...
  show_warning: function(targ) {
    if (!targ.warning) {
      ...
      targ.warning.src = "/img/alertacapslock.png";
      ...
      targ.warning.setAttribute("alt", "Atenção: sua tecla Caps Lock está ativa.");
      if (targ.warning.runtimeStyle) {
        // PNG transparency for IE
        targ.warning.runtimeStyle.filter += 
"progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/img/alertacapslock.png',sizingMethod='scale')";
      }
